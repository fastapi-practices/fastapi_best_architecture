...
async def create_project(project_data: ProjectCreateRequest) -> ResponseModel | ResponseSchemaModel:
    ...
    try:
        ...
        return response_base.fail(msg=f"创建项目失败: {str(e)}")
...
async def get_project(project_id: int = Path(..., description="项目ID")) -> ResponseModel | ResponseSchemaModel:
    ...
    try:
        ...
        if not project:
            return response_base.fail(msg="项目不存在")
        ...
        return response_base.fail(msg=f"获取项目失败: {str(e)}")
...
async def get_projects(
    ...
    try:
        ...
        return response_base.fail(msg=f"获取项目列表失败: {str(e)}")
...
async def update_project(
    ...
    try:
        ...
        return response_base.fail(msg=f"更新项目失败: {str(e)}")
...
async def delete_project(project_id: int = Path(..., description="项目ID")) -> ResponseModel | ResponseSchemaModel:
    ...
    try:
        ...
        if not success:
            return response_base.fail(msg="项目不存在或删除失败")
        
        return response_base.success(msg="项目删除成功")
    except Exception as e:
        return response_base.fail(msg=f"删除项目失败: {str(e)}")
