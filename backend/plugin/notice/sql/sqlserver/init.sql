...
INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
VALUES
('新增', 'AddNotice', NULL, 0, NULL, 2, NULL, 'sys:notice:add', 1, 0, 1, '', NULL, (SELECT id FROM sys_menu WHERE name = 'PluginNotice'), GETDATE(), NULL),
('修改', 'EditNotice', NULL, 0, NULL, 2, NULL, 'sys:notice:edit', 1, 0, 1, '', NULL, (SELECT id FROM sys_menu WHERE name = 'PluginNotice'), GETDATE(), NULL),
('删除', 'DeleteNotice', NULL, 0, NULL, 2, NULL, 'sys:notice:del', 1, 0, 1, '', NULL, (SELECT id FROM sys_menu WHERE name = 'PluginNotice'), GETDATE(), NULL);
