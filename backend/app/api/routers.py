...
v1.include_router(dict_type_router, prefix='/dict-type', tags=['字典类型管理'])
v1.include_router(dict_data_router, prefix='/dict-data', tags=['字典数据管理'])
v1.include_router(log_router, prefix='/log', tags=['日志管理'])
v1.include_router(monitor_router, prefix='/monitor', tags=['监控管理'])
v1.include_router(task_router, prefix='/task', tags=['任务管理'])
v1.include_router(mixed_router, prefix='/mixe', tags=['杂项'])
