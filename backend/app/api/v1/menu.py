...
@router.get('/sidebar', summary='获取用户菜单展示树', dependencies=[Depends(jwt_auth)])
...
@router.get('/{pk}', summary='获取菜单详情', dependencies=[Depends(jwt_auth)])
...
@router.get('', summary='获取所有菜单展示树', dependencies=[Depends(jwt_auth)])
