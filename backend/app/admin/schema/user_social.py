...
class UserSocialSchemaBase(SchemaBase):
    ...
    open_id: str | None = Field(default=None, description='开放平台 ID')
    uid: str | None = Field(default=None, description='用户 ID')
    union_id: str | None = Field(default=None, description='开放平台唯一 ID')
    scope: str | None = Field(default=None, description='授权范围')
    code: str | None = Field(default=None, description='授权码')
