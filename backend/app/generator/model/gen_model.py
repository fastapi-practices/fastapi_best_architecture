...
class GenModel(DataClassBase):
    ...
    default: Mapped[str | None] = mapped_column(LONGTEXT().with_variant(TEXT, "postgresql"), default=None, comment='列默认值')
    ...
    is_nullable: Mapped[bool] = mapped_column(Boolean().with_variant(INTEGER, "postgresql"), default=False, comment='是否可为空')
