...
VALUES (1, N'测试', 0, NULL, NULL, NULL, 1, 0, NULL, GETDATE(), NULL);
...
(6, N'新增', 'AddSysDept', NULL, 0, NULL, 2, NULL, 'sys:dept:add', 1, 0, 1, '', NULL, 5, '2025-06-26 20:29:06', NULL),
(7, N'修改', 'EditSysDept', NULL, 0, NULL, 2, NULL, 'sys:dept:edit', 1, 0, 1, '', NULL, 5, '2025-06-26 20:29:06', NULL),
(8, N'删除', 'DeleteSysDept', NULL, 0, NULL, 2, NULL, 'sys:dept:del', 1, 0, 1, '', NULL, 5, '2025-06-26 20:29:06', NULL),
...
(10, N'删除', 'DeleteSysUser', NULL, 0, NULL, 2, NULL, 'sys:user:del', 1, 0, 1, '', NULL, 9, '2025-06-26 20:29:06', NULL),
...
(12, N'新增', 'AddSysRole', NULL, 0, NULL, 2, NULL, 'sys:role:add', 1, 0, 1, '', NULL, 11, '2025-06-26 20:29:06', NULL),
(13, N'修改', 'EditSysRole', NULL, 0, NULL, 2, NULL, 'sys:role:edit', 1, 0, 1, '', NULL, 11, '2025-06-26 20:29:06', NULL),
(14, N'修改角色菜单', 'EditSysRoleMenu', NULL, 0, NULL, 2, NULL, 'sys:role:menu:edit', 1, 0, 1, '', NULL, 11, '2025-06-26 20:29:06', NULL),
(15, N'修改角色数据范围', 'EditSysRoleScope', NULL, 0, NULL, 2, NULL, 'sys:role:scope:edit', 1, 0, 1, '', NULL, 11, '2025-06-26 20:29:06', NULL),
(16, N'删除', 'DeleteSysRole', NULL, 0, NULL, 2, NULL, 'sys:role:del', 1, 0, 1, '', NULL, 11, '2025-06-26 20:29:06', NULL),
...
(18, N'新增', 'AddSysMenu', NULL, 0, NULL, 2, NULL, 'sys:menu:add', 1, 0, 1, '', NULL, 17, '2025-06-26 20:29:06', NULL),
(19, N'修改', 'EditSysMenu', NULL, 0, NULL, 2, NULL, 'sys:menu:edit', 1, 0, 1, '', NULL, 17, '2025-06-26 20:29:06', NULL),
(20, N'删除', 'DeleteSysMenu', NULL, 0, NULL, 2, NULL, 'sys:menu:del', 1, 0, 1, '', NULL, 17, '2025-06-26 20:29:06', NULL),
...
(23, N'新增', 'AddSysDataScope', NULL, 0, NULL, 2, NULL, 'data:scope:add', 1, 0, 1, '', NULL, 22, '2025-06-26 20:29:06', NULL),
(24, N'修改', 'EditSysDataScope', NULL, 0, NULL, 2, NULL, 'data:scope:edit', 1, 0, 1, '', NULL, 22, '2025-06-26 20:29:06', NULL),
(25, N'修改数据范围规则', 'EditDataScopeRule', NULL, 0, NULL, 2, NULL, 'data:scope:rule:edit', 1, 0, 1, '', NULL, 22, '2025-06-26 20:29:06', NULL),
(26, N'删除', 'DeleteSysDataScope', NULL, 0, NULL, 2, NULL, 'data:scope:del', 1, 0, 1, '', NULL, 22, '2025-06-26 20:29:06', NULL),
...
(28, N'新增', 'AddSysDataRule', NULL, 0, NULL, 2, NULL, 'data:rule:add', 1, 0, 1, '', NULL, 27, '2025-06-26 20:29:06', NULL),
(29, N'修改', 'EditSysDataRule', NULL, 0, NULL, 2, NULL, 'data:rule:edit', 1, 0, 1, '', NULL, 27, '2025-06-26 20:29:06', NULL),
(30, N'删除', 'DeleteSysDataRule', NULL, 0, NULL, 2, NULL, 'data:rule:del', 1, 0, 1, '', NULL, 27, '2025-06-26 20:29:06', NULL),
...
(37, N'删除', 'DeleteLoginLog', NULL, 0, NULL, 2, NULL, 'log:login:del', 1, 0, 1, '', NULL, 36, '2025-06-26 20:29:06', NULL),
(38, N'清空', 'EmptyLoginLog', NULL, 0, NULL, 2, NULL, 'log:login:clear', 1, 0, 1, '', NULL, 36, '2025-06-26 20:29:06', NULL),
...
(40, N'删除', 'DeleteOperaLog', NULL, 0, NULL, 2, NULL, 'log:opera:del', 1, 0, 1, '', NULL, 39, '2025-06-26 20:29:06', NULL),
(41, N'清空', 'EmptyOperaLog', NULL, 0, NULL, 2, NULL, 'log:opera:clear', 1, 0, 1, '', NULL, 39, '2025-06-26 20:29:06', NULL),
...
(46, N'项目', 'Project', '/fba', 5, 'https://wu-clan.github.io/picx-images-hosting/logo/fba.png', 0, NULL, NULL, 1, 1, 1, '', NULL, NULL, '2025-06-26 20:29:06', NULL),
(47, N'文档', 'Document', '/fba/document', 1, 'lucide:book-open-text', 4, '/_core/fallback/iframe.vue', NULL, 1, 1, 1, 'https://fastapi-practices.github.io/fastapi_best_architecture_docs', NULL, 46, '2025-06-26 20:29:06', NULL),
...
VALUES (1, N'测试', 1, 1, NULL, GETDATE(), NULL);
...
VALUES
(1, CONVERT(varchar(36), NEWID()), 'admin', N'用户88888', '$2b$12$8y2eNucX19VjmZ3tYhBLcOsBwy9w1IjBQE4SSqwMDL5bGQVp2wqS.', 0x24326224313224387932654E7563583139566A6D5A33745968424C634F, 'admin@example.com', 1, 1, 1, 1, NULL, NULL, GETDATE(), GETDATE(), GETDATE(), 1, GETDATE(), NULL),
(2, CONVERT(varchar(36), NEWID()), 'test', N'用户66666', '$2b$12$BMiXsNQAgTx7aNc7kVgnwedXGyUxPEHRnJMFbiikbqHgVoT3y14Za', 0x24326224313224424D6958734E514167547837614E63376B56676E7765, 'test@example.com', 1, 0, 0, 0, NULL, NULL, GETDATE(), GETDATE(), GETDATE(), 1, GETDATE(), NULL);
...
VALUES
(1, N'本部门数据权限', 1, GETDATE(), NULL),
(2, N'部门及以下数据权限', 1, GETDATE(), NULL),
(3, N'仅本人数据权限', 1, GETDATE(), NULL),
(4, N'全模型本部门数据权限', 1, GETDATE(), NULL),
(5, N'排除超级管理员数据权限', 1, GETDATE(), NULL);
...
VALUES
(1, N'部门 ID 等于当前用户部门', 'Dept', '__dept_id__', 0, 0, '${dept_id}', GETDATE(), NULL),
(2, N'部门名称等于测试', 'Dept', 'name', 1, 0, N'测试', GETDATE(), NULL),
(3, N'父部门 ID 等于测试部门 ID', 'Dept', 'parent_id', 0, 0, '1', GETDATE(), NULL),
(4, N'创建者等于当前用户', '__ALL__', '__created_by__', 0, 0, '${user_id}', GETDATE(), NULL),
(5, N'全模型部门 ID 等于当前用户部门', '__ALL__', '__dept_id__', 0, 0, '${dept_id}', GETDATE(), NULL),
(6, N'用户非超级管理员', 'User', 'is_superuser', 0, 1, '1', GETDATE(), NULL);
