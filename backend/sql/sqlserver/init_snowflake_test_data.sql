...
VALUES (2048601258595581952, '测试', 0, NULL, NULL, NULL, 1, 0, NULL, GETDATE(), NULL);
...
VALUES (2048601263515500544, '测试', 1, 1, NULL, GETDATE(), NULL);
...
VALUES
(2048601263834267648, CONVERT(varchar(36), NEWID()), 'admin', '用户88888', '$2b$12$8y2eNucX19VjmZ3tYhBLcOsBwy9w1IjBQE4SSqwMDL5bGQVp2wqS.', 0x24326224313224387932654E7563583139566A6D5A33745968424C634F, 'admin@example.com', 1, 1, 1, 1, NULL, NULL, GETDATE(), GETDATE(), GETDATE(), 2048601258595581952, GETDATE(), NULL),
(2049946297615646720, CONVERT(varchar(36), NEWID()), 'test', '用户66666', '$2b$12$BMiXsNQAgTx7aNc7kVgnwedXGyUxPEHRnJMFbiikbqHgVoT3y14Za', 0x24326224313224424D6958734E514167547837614E63376B56676E7765, 'test@example.com', 1, 0, 0, 0, NULL, NULL, GETDATE(), GETDATE(), GETDATE(), 2048601258595581952, GETDATE(), NULL);
...
VALUES
(2048601263901376512, '本部门数据权限', 1, GETDATE(), NULL),
(2048601263968485376, '部门及以下数据权限', 1, GETDATE(), NULL),
(2048601263968485377, '仅本人数据权限', 1, GETDATE(), NULL),
(2048601263968485378, '全模型本部门数据权限', 1, GETDATE(), NULL),
(2048601263968485379, '排除超级管理员数据权限', 1, GETDATE(), NULL);

INSERT INTO sys_data_rule (id, name, model, [column], operator, expression, [value], created_time, updated_time)
VALUES
(2048601264035594240, '部门 ID 等于当前用户部门', 'Dept', '__dept_id__', 0, 0, '${dept_id}', GETDATE(), NULL),
(2048601264102703104, '部门名称等于测试', 'Dept', 'name', 1, 0, '测试', GETDATE(), NULL),
(2048601264102703105, '父部门 ID 等于测试部门 ID', 'Dept', 'parent_id', 0, 0, '1', GETDATE(), NULL),
(2048601264102703106, '创建者等于当前用户', '__ALL__', '__created_by__', 0, 0, '${user_id}', GETDATE(), NULL),
(2048601264102703107, '全模型部门 ID 等于当前用户部门', '__ALL__', '__dept_id__', 0, 0, '${dept_id}', GETDATE(), NULL),
(2048601264102703109, '用户非超级管理员', 'User', 'is_superuser', 0, 1, '1', GETDATE(), NULL);
