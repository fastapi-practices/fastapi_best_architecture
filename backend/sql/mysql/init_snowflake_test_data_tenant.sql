insert into sys_dept (id, name, sort, leader, phone, email, status, del_flag, parent_id, created_time, updated_time, tenant_id)
values (2048601258595581952, '测试', 0, null, null, null, 1, false, null, now(), null, 0);
