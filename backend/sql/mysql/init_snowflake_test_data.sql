...
insert into sys_role_menu (id, role_id, menu_id)
select 2048601263775547393, 2048601263515500544, id from sys_menu where name = 'Workflow';

insert into sys_role_menu (id, role_id, menu_id)
select 2048601263775547394, 2048601263515500544, id from sys_menu where name = 'WorkflowStartApply';

insert into sys_role_menu (id, role_id, menu_id)
select 2048601263775547395, 2048601263515500544, id from sys_menu where name = 'WorkflowApply';
