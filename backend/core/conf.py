...
class Settings(BaseSettings):
    ...
    OPERA_LOG_ENCRYPT_SECRET_KEY: str  # key os.urandom(32), to be converted to bytes.hex() str
    ...
    OPERA_LOG_ENCRYPT_TYPE: int = 1  # 0: AES (performance loss); 1: md5; 2: ItsDangerous; 3: Unencrypted, others: replace with ******
